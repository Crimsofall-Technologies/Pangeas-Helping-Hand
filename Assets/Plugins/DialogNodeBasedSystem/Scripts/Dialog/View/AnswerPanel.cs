...
namespace cherrydev
{
    public class AnswerPanel : MonoBehaviour
    {
        ...
        private readonly List<Text> _buttonTexts = new();
        ...
        public void SetUpButtons(int maxAmountOfAnswerButtons)
        {
            ...
            for (int i = 0; i < maxAmountOfAnswerButtons; i++)
            {
                ...
                _buttonTexts.Add(answerButton.GetComponentInChildren<Text>());
            }
        }
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        public Text GetButtonTextByIndex(int index) => _buttonTexts[index];
